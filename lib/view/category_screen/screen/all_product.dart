  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:const Text("All Product",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w600,color: Colors.white),),
      ...
      body: Padding(
        ...
        child:  Column(
          ...
          children: [
            const Text("All Product ",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w700,color: Colors.white),),
